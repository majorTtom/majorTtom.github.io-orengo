$(document).ready(function(){
  ...
  /*ЗАКУСКИ*/
  /*сэндв с семгой(ssem)*/
  $(document).on('mouseover', '.ssem', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseout', '.ssem', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseover', '.btd', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseout', '.btd', function(e){
    e.preventDefault;
  ...
  /*ТОРТЫ*/
  /*меренговый рулет(mr)*/
  $(document).on('mouseover', '.mr', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseout', '.mr', function(e){
    e.preventDefault;
  ...
  /*наролеон(nap)*/
  $(document).on('mouseover', '.nap', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseout', '.nap', function(e){
    e.preventDefault;
  ...
  /*ГРАНОЛА*/
  /*gr1*/
  $(document).on('mouseover', '.gr1', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseout', '.gr1', function(e){
    e.preventDefault;
  ...
  /*gr6*/
  $(document).on('mouseover', '.gr6', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseout', '.gr6', function(e){
    e.preventDefault;
  ...
  /*ВЫПЕЧКА*/
  /*маджио(maj)*/
  $(document).on('mouseover', '.maj', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseout', '.maj', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseover', '.krsh', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseout', '.krsh', function(e){
    e.preventDefault;
  ...
  /*ПИРОГИ*/
  /*лималина(lmln)*/
  $(document).on('mouseover', '.lmln', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseout', '.lmln', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseover', '.shok', function(e){
    e.preventDefault;
  ...
  $(document).on('mouseout', '.shok', function(e){
    e.preventDefault;
